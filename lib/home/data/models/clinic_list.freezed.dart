...
/// @nodoc
mixin _$ClinicList {
  List<ClinicModel> get clinicList => throw _privateConstructorUsedError;
...
abstract class $ClinicListCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ClinicModel> clinicList});
}
...
/// @nodoc
@JsonSerializable()
class _$_ClinicList implements _ClinicList {
  const _$_ClinicList({required final List<ClinicModel> clinicList})
      : _clinicList = clinicList;

  factory _$_ClinicList.fromJson(Map<String, dynamic> json) =>
      _$$_ClinicListFromJson(json);

  final List<ClinicModel> _clinicList;
  @override
  List<ClinicModel> get clinicList {
  ...
  @override
  String toString() {
    return 'ClinicList(clinicList: $clinicList)';
  }
...
abstract class _ClinicList implements ClinicList {
  const factory _ClinicList({required final List<ClinicModel> clinicList}) =
      _$_ClinicList;
